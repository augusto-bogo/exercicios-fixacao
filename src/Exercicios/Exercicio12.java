...
public class Exercicio12 {
    public static void main(String[] args) {
        ...
        switch (formaPagamento){
            case 1:
                valorFinalProduto = preco - (preco * 0.15);
                System.out.printf("Valor final com desconto: R$ %.2f\n", valorFinalProduto);
                break;
            case 2:
                valorFinalProduto = preco - (preco * 0.10);
                System.out.printf("Valor final com desconto: R$ %.2f\n", valorFinalProduto);
                break;
            case 3:
                valorFinalProduto = preco;
                System.out.printf("Valor final: R$ %.2f (2x de R$ %.2f)\n", valorFinalProduto, valorFinalProduto / 2);
                break;
            case 4:
                valorFinalProduto = preco + (preco * 0.10);
